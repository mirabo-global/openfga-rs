...
pub async fn batch_check(configuration: &configuration::Configuration, store_id: &str, body: models::BatchCheckRequest) -> Result<models::BatchCheckResponse, Error<BatchCheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/batch-check", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
...
pub async fn check(configuration: &configuration::Configuration, store_id: &str, body: models::CheckRequest) -> Result<models::CheckResponse, Error<CheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/check", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn expand(configuration: &configuration::Configuration, store_id: &str, body: models::ExpandRequest) -> Result<models::ExpandResponse, Error<ExpandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/expand", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn list_objects(configuration: &configuration::Configuration, store_id: &str, body: models::ListObjectsRequest) -> Result<models::ListObjectsResponse, Error<ListObjectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/list-objects", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn list_users(configuration: &configuration::Configuration, store_id: &str, body: models::ListUsersRequest) -> Result<models::ListUsersResponse, Error<ListUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/list-users", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn streamed_list_objects(configuration: &configuration::Configuration, store_id: &str, body: models::ListObjectsRequest) -> Result<models::StreamResultOfStreamedListObjectsResponse, Error<StreamedListObjectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_body_body = body;

    let uri_str = format!("{}/stores/{store_id}/streamed-list-objects", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
