...
pub async fn list_stores(configuration: &configuration::Configuration, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<models::ListStoresResponse, Error<ListStoresError>> {
    let local_var_configuration = configuration;
