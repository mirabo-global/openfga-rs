...
pub async fn create_store(configuration: &configuration::Configuration, body: models::CreateStoreRequest) -> Result<models::CreateStoreResponse, Error<CreateStoreError>> {
...
pub async fn delete_store(configuration: &configuration::Configuration, store_id: &str) -> Result<(), Error<DeleteStoreError>> {
    ...
    let uri_str = format!("{}/stores/{store_id}", configuration.base_path, store_id=crate::apis::urlencode(p_path_store_id));
...
pub async fn get_store(configuration: &configuration::Configuration, store_id: &str) -> Result<models::GetStoreResponse, Error<GetStoreError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
...
pub async fn list_stores(configuration: &configuration::Configuration, page_size: Option<i32>, continuation_token: Option<&str>, name: Option<&str>) -> Result<models::ListStoresResponse, Error<ListStoresError>> {
    // add a prefix to parameters to efficiently prevent name collisions
