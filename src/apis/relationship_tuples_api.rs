...
pub async fn read_changes(configuration: &configuration::Configuration, store_id: &str, r#type: Option<&str>, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<models::ReadChangesResponse, Error<ReadChangesError>> {
    let local_var_configuration = configuration;
