...
> models::ReadAuthorizationModelResponse read_authorization_model(store_id, id)
...
[**models::ReadAuthorizationModelResponse**](ReadAuthorizationModelResponse.md)
...
> models::ReadAuthorizationModelsResponse read_authorization_models(store_id, page_size, continuation_token)
...
[**models::ReadAuthorizationModelsResponse**](ReadAuthorizationModelsResponse.md)
...
> models::WriteAuthorizationModelResponse write_authorization_model(store_id, body)
...
[**models::WriteAuthorizationModelResponse**](WriteAuthorizationModelResponse.md)
